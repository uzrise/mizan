...
const Icon3 = ({ color = '#02352D' }) => (<svg width="200" height="200" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {values.map((value) => {
              ...
              return (
                ...
                >
                  ...
                  <div 
                    className="absolute bottom-4 right-4 w-[200px] h-[200px] transition-transform duration-700 ease-out"
                    style={{
                  ...
                  >
                    {(() => {
                      ...
                      return <IconComponent color={isActive ? '#FFFFFF' : '#02352D'} />;
                    })()}
                  </div>
                </div>
              );
